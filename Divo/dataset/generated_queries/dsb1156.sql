--dsb_templates_query099_098_fdc795f1-9213-30c1-8a3f-2b412b518b2f.sql
--{"gen": "erase", "time": 1.0708162784576416, "template": "query099_098", "dataset": "dsb_templates", "rows": 3}
...
WHERE (date_dim.d_month_seq BETWEEN 1202 AND 1202 + 23 AND catalog_sales.cs_list_price BETWEEN 74 AND 103 AND ship_mode.sm_type = 'EXPRESS' AND call_center.cc_class = 'medium' AND catalog_sales.cs_ship_date_sk = date_dim.d_date_sk AND catalog_sales.cs_ship_mode_sk = ship_mode.sm_ship_mode_sk AND catalog_sales.cs_call_center_sk = call_center.cc_call_center_sk)
