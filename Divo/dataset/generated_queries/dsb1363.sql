--dsb_templates_generated-146262db-cfe1-4e7c-abd5-fbfea7cc31da_10d9348a-e4c9-34b5-b372-175daa527caa.sql
--{"gen": "erase", "time": 0.8838896751403809, "template": "generated-146262db-cfe1-4e7c-abd5-fbfea7cc31da", "dataset": "dsb_templates", "rows": 9}
...
WHERE (catalog_sales.cs_list_price BETWEEN 178 AND 207 AND call_center.cc_class = 'large' AND warehouse.w_gmt_offset = -5 AND catalog_sales.cs_warehouse_sk = warehouse.w_warehouse_sk AND catalog_sales.cs_call_center_sk = call_center.cc_call_center_sk)
