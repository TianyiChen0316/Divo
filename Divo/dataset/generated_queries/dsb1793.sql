--dsb_templates_query099_098_ba765975-d833-34d9-a1cf-cba8df15fd27.sql
--{"gen": "erase", "time": 1.0361154079437256, "template": "query099_098", "dataset": "dsb_templates", "rows": 3}
...
WHERE (date_dim.d_month_seq BETWEEN 1197 AND 1197 + 23 AND catalog_sales.cs_list_price BETWEEN 49 AND 78 AND ship_mode.sm_type = 'OVERNIGHT' AND call_center.cc_class = 'large' AND catalog_sales.cs_ship_date_sk = date_dim.d_date_sk AND catalog_sales.cs_ship_mode_sk = ship_mode.sm_ship_mode_sk AND catalog_sales.cs_call_center_sk = call_center.cc_call_center_sk)
