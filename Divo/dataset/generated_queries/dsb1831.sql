--dsb_templates_generated-5192e4d5-79f2-4018-8803-132dae96aae7_262a1ce2-e945-38e0-93fc-0f51db83948c.sql
--{"gen": "erase", "time": 0.38843631744384766, "template": "generated-5192e4d5-79f2-4018-8803-132dae96aae7", "dataset": "dsb_templates", "rows": 1}
...
WHERE (d2.d_year = 2001 AND d2.d_moy = 1 AND store_sales.ss_ticket_number = store_returns.sr_ticket_number AND store_sales.ss_item_sk = store_returns.sr_item_sk AND store_returns.sr_returned_date_sk = d2.d_date_sk AND store_sales.ss_customer_sk = store_returns.sr_customer_sk)
 LIMIT 100