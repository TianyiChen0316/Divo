--dsb_templates_query050_013_eb816985-5680-3b03-b638-2ca830d61c19.sql
--{"gen": "combine", "time": 0.4045116901397705, "template": "query050_013", "dataset": "dsb_templates", "rows": 12}
SELECT store.s_city,
store.s_company_id,
store.s_county,
store.s_state,
...
WHERE (d2.d_moy = 3 AND d2.d_year = 1999 AND store_returns.sr_returned_date_sk = d2.d_date_sk AND store_sales.ss_customer_sk = store_returns.sr_customer_sk AND store_sales.ss_item_sk = store_returns.sr_item_sk AND store_sales.ss_sold_date_sk = d1.d_date_sk AND store_sales.ss_store_sk = store.s_store_sk AND store_sales.ss_ticket_number = store_returns.sr_ticket_number AND d1.d_date BETWEEN d2.d_date - '120 day'::interval AND d2.d_date)
