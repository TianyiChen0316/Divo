--dsb_templates_generated-87f5dfba-ef93-4967-ad50-6e909904ebe9_4ec7a704-e1b5-3622-8e7e-a0140b48c00e.sql
--{"gen": "erase", "time": 0.2637002468109131, "template": "generated-87f5dfba-ef93-4967-ad50-6e909904ebe9", "dataset": "dsb_templates", "rows": 1}
...
WHERE (d2.d_year = 2000 AND d2.d_moy = 4 AND store_sales.ss_ticket_number = store_returns.sr_ticket_number AND store_sales.ss_item_sk = store_returns.sr_item_sk AND store_returns.sr_returned_date_sk = d2.d_date_sk AND store_sales.ss_customer_sk = store_returns.sr_customer_sk)
 LIMIT 100