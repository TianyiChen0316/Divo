--dsb_templates_generated-5192e4d5-79f2-4018-8803-132dae96aae7_5c375abd-915a-32aa-a1e7-421e492b5346.sql
--{"gen": "combine", "time": 0.33338022232055664, "template": "generated-5192e4d5-79f2-4018-8803-132dae96aae7", "dataset": "dsb_templates", "rows": 1}
...
store AS store
WHERE (d2.d_year = 2001 AND d2.d_moy = 12 AND store_sales.ss_ticket_number = store_returns.sr_ticket_number AND store_sales.ss_item_sk = store_returns.sr_item_sk AND store_sales.ss_sold_date_sk = d1.d_date_sk AND store_returns.sr_returned_date_sk = d2.d_date_sk AND store_sales.ss_customer_sk = store_returns.sr_customer_sk AND store_sales.ss_store_sk = store.s_store_sk AND d1.d_date BETWEEN d2.d_date - '120 day'::interval AND d2.d_date)
 LIMIT 100