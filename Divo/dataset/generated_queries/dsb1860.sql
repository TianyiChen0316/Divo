--dsb_templates_generated-75784149-3b7f-434f-a814-a10b3a716656_669ea5e8-7170-382a-b57a-7e541bce1723.sql
--{"gen": "erase", "time": 0.8295717239379883, "template": "generated-75784149-3b7f-434f-a814-a10b3a716656", "dataset": "dsb_templates", "rows": 12}
SELECT store.s_city,
store.s_company_id,
store.s_county,
store.s_state,
...
WHERE (d2.d_year = 2000 AND d2.d_moy = 4 AND store_sales.ss_ticket_number = store_returns.sr_ticket_number AND store_sales.ss_item_sk = store_returns.sr_item_sk AND store_returns.sr_returned_date_sk = d2.d_date_sk AND store_sales.ss_customer_sk = store_returns.sr_customer_sk AND store_sales.ss_store_sk = store.s_store_sk AND household_demographics.hd_demo_sk = customer.c_current_hdemo_sk AND store_returns.sr_cdemo_sk = customer.c_current_cdemo_sk)
