--dsb_templates_generated-5192e4d5-79f2-4018-8803-132dae96aae7_c4baecee-e75a-3a4e-a530-1a7f2aad98c7.sql
--{"gen": "erase", "time": 4.20720648765564, "template": "generated-5192e4d5-79f2-4018-8803-132dae96aae7", "dataset": "dsb_templates", "rows": 1}
...
WHERE (store_sales.ss_ticket_number = store_returns.sr_ticket_number AND store_sales.ss_item_sk = store_returns.sr_item_sk AND store_sales.ss_sold_date_sk = d1.d_date_sk AND store_sales.ss_customer_sk = store_returns.sr_customer_sk)
 LIMIT 100