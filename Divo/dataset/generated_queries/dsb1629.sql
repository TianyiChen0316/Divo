--dsb_templates_query099_098_18a75064-34bf-3cf4-ae93-c8c68987913d.sql
--{"gen": "erase", "time": 0.8947997093200684, "template": "query099_098", "dataset": "dsb_templates", "rows": 2}
...
WHERE (date_dim.d_month_seq BETWEEN 1180 AND 1180 + 23 AND catalog_sales.cs_list_price BETWEEN 181 AND 210 AND ship_mode.sm_type = 'OVERNIGHT' AND call_center.cc_class = 'large' AND catalog_sales.cs_ship_date_sk = date_dim.d_date_sk AND catalog_sales.cs_ship_mode_sk = ship_mode.sm_ship_mode_sk AND catalog_sales.cs_call_center_sk = call_center.cc_call_center_sk)
