--dsb_templates_query099_098_a8b2f07a-184c-346c-80e0-a9fa6ec8241a.sql
--{"gen": "erase", "time": 0.8854625225067139, "template": "query099_098", "dataset": "dsb_templates", "rows": 3}
...
WHERE (date_dim.d_month_seq BETWEEN 1198 AND 1198 + 23 AND catalog_sales.cs_list_price BETWEEN 171 AND 200 AND ship_mode.sm_type = 'TWO DAY' AND call_center.cc_class = 'medium' AND catalog_sales.cs_ship_date_sk = date_dim.d_date_sk AND catalog_sales.cs_ship_mode_sk = ship_mode.sm_ship_mode_sk AND catalog_sales.cs_call_center_sk = call_center.cc_call_center_sk)
