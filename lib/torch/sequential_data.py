...
class _TensorFixedPlaceholder(metaclass=PlaceholderMetaclass, type=torch.Tensor, placeholder_name='_tensor', init_hook='__create_tensor'):
    ...
    def __reduce__(self):
        return (_TensorFixedPlaceholder, (self._parent, self._target_field, self._item, self._target_shape, self._dtype))
...
class _TensorPlaceholder(metaclass=PlaceholderMetaclass, type=torch.Tensor, placeholder_name='_tensor'):
    ...
    def __reduce__(self):
        return (_TensorPlaceholder, (self._parent, self._target_field, self._item, self._target_shape))
