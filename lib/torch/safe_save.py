...
def save_torch(
    ...
    def save(o, p):
        return torch.save(o, p, pickle_module=pickle_module, pickle_protocol=pickle_protocol)
    return _safe_save(obj, path, save, temp_file)
...
def load_torch(
    ...
    **pickle_load_args,
    ...
    def load(p):
        return torch.load(p, map_location=map_location, pickle_module=pickle_module,
